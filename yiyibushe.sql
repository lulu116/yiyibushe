...
(2, '刘婷', 'e10adc3949ba59abbe56e057f20f883e', 38, '2018-01-18 11:03:32');
...
INSERT INTO `suggest` (`suggest_id`, `user_id`, `types`, `admin_id`, `content`) VALUES
(1, 8, '退款问题', 2, 'ddsfgdasfdsafae5fdsrd'),
(2, 8, '退款问题', 2, 'ddsfgdasfdsafae5fdsrd'),
(3, 8, '退款问题', 2, ''),
(4, 8, '退款问题', 2, ''),
(5, 8, '退换货', 2, 'ert5t24352435435'),
(6, 8, '支付问题', 2, 'dfdfd'),
(7, 8, '支付问题', 2, 'dfdfd'),
(8, 9, '支付问题', 2, 'erevev妥在有'),
(9, 9, '支付问题', 2, '摇篮');
...
(8, '刘婷', 'ae853b399783b7ccbde9de2c61aa4d9b', 'userimg.jpg', '123456789', '2017-12-19 20:56:52', 37, '2018-01-18 11:01:01', '2018-01-09 14:04:13', '四川省广元市苍溪县高级职业中学 张三（收）。'),
